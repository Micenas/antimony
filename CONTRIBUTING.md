Contributing to premiumcoin Core
============================

The premiumcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the premiumcoin Core project, and is not to be
confused with overall premiumcoin Network Protocol consensus changes.

Whether a pull request is merged into premiumcoin Core rests with the project merge
...
Patches that change premiumcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the premiumcoin consensus, it must have been
...
The project leader is the release manager for each premiumcoin Core release.
