...
/** Utility functions used by the premiumcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render premiumcoin addresses in monospace font
...
// Parse "premiumcoin:" URI into recipient object, return true on successful parsing
