                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("premiumcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a premiumcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and premiumcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About premiumcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about premiumcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for premiumcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your premiumcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified premiumcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a premiumcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the premiumcoin Core help message to get a list with possible premiumcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("premiumcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to premiumcoin network", "", count));
}
...
{
    QString strTitle = tr("premiumcoin Core"); // default title
