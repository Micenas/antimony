...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
		...
		return false;
            ...
            try {
                ...
                QMessageBox::critical(0, tr("premiumcoin Core"),
     ...
     * override -datadir in the premiumcoin.conf file in the default data directory
     * (to be consistent with premiumcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
