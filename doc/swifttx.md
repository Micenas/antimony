...
This mechanism has been integrated into Bitcore-Node-premiumcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/premiumcoin-crypto/insight-api-premiumcoin#web-socket-api](https://github.com/premiumcoin-crypto/insight-api-premiumcoin#web-socket-api)
* API: [https://github.com/premiumcoin-crypto/insight-api-premiumcoin#swifttx-transactions](https://github.com/premiumcoin-crypto/insight-api-premiumcoin#swifttx-transactions)
...
By default, the premiumcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the premiumcoin Core daemon:
