...
In order to support loading of multiple wallets in premiumcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is premiumcoin.cpp.
...
Changes to premiumcoin.cpp
----------------------
premiumcoin.cpp is the entry point into premiumcoin-qt, and as such, will require some minor modifications to provide hooks for
